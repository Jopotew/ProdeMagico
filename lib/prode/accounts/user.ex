defmodule Prode.Accounts.User do
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Prode.Repo)
  ...
  def google_registration_changeset(user, attrs) do
    user
    |> cast(attrs, [:email, :google_uid, :display_name, :avatar_url])
  ...
  """
  def valid_password?(%Prode.Accounts.User{hashed_password: hashed_password}, password)
